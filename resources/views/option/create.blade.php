                            ...
                            <div class="col-8">
                                <div class="p-20">
                                    ...
                                    <form action="{{route('option.store')}}" method="post">
                                        ...
                                        <div class="form-group row">
                                            {!! Form::label('description','KEY'.$red,['class'=>'col-2 col-form-label'],false) !!}
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            {!! Form::label('group_name','内容'.$red ,['class'=>'col-2 col-form-label '],false) !!}
                                            <div class="col-6">
                                                <textarea type="text" name="value" required
                                                       class="form-control {{$errors->has('group_name')?'is-invalid':''}}" placeholder="可以为数组，json"></textarea>
                                                @if ($errors->has('value'))
                                                    <span class="invalid-feedback" role="alert">
